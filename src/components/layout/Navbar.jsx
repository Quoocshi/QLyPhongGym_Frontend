      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a href="#services" className="text-gray-600 hover:text-primary transition font-medium">Dịch vụ</a>
            <a href="#trainers" className="text-gray-600 hover:text-primary transition font-medium">Huấn luyện viên</a>
      ...
      {isOpen && (
        <div className="md:hidden bg-white border-t">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <a href="#services" className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-primary hover:bg-orange-50">Dịch vụ</a>
            <a href="#trainers" className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-primary hover:bg-orange-50">Huấn luyện viên</a>
